...
<p class='bblib' style='margin-top:0;'><b><tt>[url=address target=target]title[/url]</tt></b><br />
	...
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[url]http://www.google.com[/url]</tt> &nbsp; --&gt; &nbsp; <a href="http://www.google.com">http://www.google.com</a><br />
	<br />
	In the second form, you can specify the text to appear within the link:<br />
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[url=http://www.google.com]Google![/url]</tt> &nbsp; --&gt; &nbsp; <a href="http://www.google.com">Google!</a><br />
	<br />
...
<p class='bblib' style='margin-top:0;'><b><tt>[email=address]title[/email]</tt></b><br />
	...
	<tt>[url]</tt> tag, it is available in two forms.  In the first form, it simply marks the e-mail address as a link:<br />
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[email]billg@microsoft.com[/email]</tt> &nbsp; --&gt; &nbsp; <a href="mailto:billg@microsoft.com">billg@microsoft.com</a><br />
	<br />
	In the second form, you can specify the text to appear within the link:<br />
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[email=billg@microsoft.com]Bill G.[/email]</tt> &nbsp; --&gt; &nbsp; <a href="mailto:billg@microsoft.com">Bill G.</a><br />
	<br />
...
<p class='bblib' style='margin-top:0;'><b><tt>[wiki="name" title="title"]</tt></b><br />
	...
	the section on <a href="../../../../nbbc-1.4.5/doc/src/usage_wiki.html">wiki tags</a> for more details):  The <tt>[[wiki]]</tt> tag
	...
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[[The White House]]</tt> &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">The White House</a><br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[wiki="The White House"]</tt> &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">The White House</a><br />
	<br />
	In the second form, you can specify the text to appear within the link:<br />
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[[The White House|1600 Pennsylvania Avenue]]</tt> &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">1600 Pennsylvania Avenue</a><br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[wiki="The White House" title="1600 Pennsylvania Avenue"]</tt> &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">1600 Pennsylvania Avenue</a><br />
	<br />
	Both of these are considerably shorter and easier to use than the <tt>[url]</tt>-based version, which is why wiki-links exist:<br />
	<br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[[The White House]]</tt> &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">The White House</a><br /><br />
	&nbsp; &nbsp; &nbsp; &nbsp; <tt>[url=http://en.wikipedia.org/wiki/The_White_House]The White House[/url]</tt><br />
	&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; --&gt; &nbsp; <a href="http://en.wikipedia.org/wiki/The_White_House">The White House</a><br />
	<br />
