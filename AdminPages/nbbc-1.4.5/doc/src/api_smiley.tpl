...
<div class='api'>
	...
	<div class='api_descr'>This function adds a new smiley.  Smileys, or emoticons, are character
		...
		<img src="../../../../nbbc-1.4.5/doc/smileys/smile.gif" width='16' height='16' alt=":-)" />.  To add a smiley, call
	...
	<div class='api_info_block'>
		(The user's manual, section <a href="../../../../nbbc-1.4.5/doc/src/usage_smiley.html">III.D</a> as well as
		<a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">appendix A</a>, contains additional documentation on
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the image for a given smiley,
		by name, the same array as was most recently given to <a href="../../../../nbbc-1.4.5/doc/src/api_smiley.html#ref_parser_AddSmiley">AddSmiley()</a>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the default smiley image name
		...
		This provides you with an easy way to look up a smiley provided by the <a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">Standard Smileys</a>.</div>
	<div class='api_info'><b>Parameters:</b>
		<ul>
		<li><i>name</i>: The text form of the smiley whose image name you'd like to retrieve.</li>
		</ul>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns a key =&gt; value array that contains <i>all</i>
		of the default smileys --- all of the smileys in the set of <a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">Standard Smileys</a>.  Each key
...
<div class='api'>
	...
	<div class='api_descr'>This function causes the BBCode object's entire current set of smileys to be
		...
		<a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">Standard Smileys</a>.  All of the existing smiley definitions in this
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current smiley directory.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_smiley.html#ref_parser_SetSmileyDir">SetSmileyDir()</a> for more details.</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current smiley URL.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_smiley.html#ref_parser_SetSmileyURL">SetSmileyURL()</a> for more details.</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current enable-smileys state.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_smiley.html#ref_parser_SetEnableSmileys">SetEnableSmileys()</a> for more details.</div>
