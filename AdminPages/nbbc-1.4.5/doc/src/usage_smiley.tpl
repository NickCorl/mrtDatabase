...
full list of the standard smileys in the <a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">appendix</a>.)  But
...
<p>That's all it takes; the <tt>:dogcar:</tt> smiley is now available!</p>
	...
	<div class='tipbox_content'><div class='tipbox_content2'>
		...
		<p style='margin-left: 2em;'><tt><img src="../../../../nbbc-1.4.5/doc/smileys/teeth.gif" width='16' height='16' alt='83' /> people died in that plane crash.</tt></p>
