...
<li><tt>nbbc/tools/collect_smileys.php</tt> &nbsp; &nbsp; &nbsp; (used for creating an HTML <a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">table of smileys</a>)</li>
...
You can find a complete list of these smileys in <a href="../../../../nbbc-1.4.5/doc/src/app_smiley.html">Appendix A</a>.</p>
