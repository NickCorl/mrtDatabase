...
with its <a href="../../../../nbbc-1.4.5/doc/src/api_behv.html#ref_parser_SetLimit">SetLimit()</a> function.</p>
...
<a href="../../../../nbbc-1.4.5/doc/src/api_behv.html#ref_parser_SetLimitPrecision">SetLimitPrecision()</a> function, and you can
control what gets added on the end (like the ellipsis) with the
<a href="../../../../nbbc-1.4.5/doc/src/api_behv.html#ref_parser_SetLimitTail">SetLimitTail()</a> function.  You can also determine
whether the text was cut off or not in the last parse job with the
<a href="../../../../nbbc-1.4.5/doc/src/api_behv.html#ref_parser_WasLimited">WasLimited()</a> function.</p>
...
the text to even span multiple lines, you'll have to use <a href="../../../../nbbc-1.4.5/doc/src/api_misc.html#ref_parser_nl2br">nl2br()</a>
