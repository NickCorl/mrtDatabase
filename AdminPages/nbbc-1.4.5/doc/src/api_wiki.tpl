...
<div class='api'>
	...
	<div class='api_descr'>This function changes the current wiki URL to the provided
		...
		See the section on <a href="../../../../nbbc-1.4.5/doc/src/usage_wiki">wiki-links</a> for more information on
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current wiki URL, as set by
		<a href="../../../../nbbc-1.4.5/doc/src/ref_parser_SetWikiURL">SetWikiURL()</a>.  If no wiki URL has been
		set, the return value is the same as that of
		<a href="../../../../nbbc-1.4.5/doc/src/ref_parser_GetDefaultWikiURL">GetDefaultWikiURL()</a>.</div>
