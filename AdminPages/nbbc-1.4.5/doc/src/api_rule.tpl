...
<div class='api'>
	...
	<div class='api_descr'>This function adds a new tag rule.  Tag rules control the processing of
		...
		<a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">rule parameters</a> that defines what NBBC should do when it sees
	...
	<div class='api_info'><b>Parameters:</b>
		...
		<li><i>params</i>:  An array of <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">rule parameters</a> defining
			what NBBC should do when it processes this tag.</li>
		</ul>
	</div>
	<div class='api_info'><b>Return Value:</b>  None.</div>
	<div class='api_info_block'>
		(The user's manual, sections <a href="../../../../nbbc-1.4.5/doc/src/usage_add.html">III.C</a> through
		<a href="../../../../nbbc-1.4.5/doc/src/usage_call.html">III.F</a> as well as <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">appendix B</a>
		and <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">appendix E</a>, contains extensive documentation on
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">parameter array</a> for a given tag,
		by name, the same array as was most recently given to <a href="../../../../nbbc-1.4.5/doc/src/api_root.html#ref_parser_AddRule">AddRule()</a>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the default <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">parameter array</a>
		for a given tag, by name, the same array that would be used by a newly-constructed BBCode object.
		This provides you with an easy way to look up a rule provided by the <a href="../../../../nbbc-1.4.5/doc/src/bbc.html">Standard BBCode Library</a>.</div>
	<div class='api_info'><b>Parameters:</b>
		<ul>
		<li><i>name</i>: The name of the tag whose parameters you'd like to retrieve.</li>
		</ul>
...
<div class='api'>
	...
	<div class='api_descr'>This function changes the <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">parameter array</a>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns a key =&gt; value array that contains <i>all</i>
		of the default rules --- all of the rules for the <a href="../../../../nbbc-1.4.5/doc/src/bbc.html">Standard BBCode Library</a>.  Each key
		is the name of a tag, and each value is an array containing <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">rule parameters</a>.
...
<div class='api'>
	...
	<div class='api_descr'>This function causes the BBCode object's entire current ruleset to be
		...
		<a href="../../../../nbbc-1.4.5/doc/src/bbc.html">Standard BBCode Library</a>.  All of the existing rules of this
