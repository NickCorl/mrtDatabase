...
a given chunk of input is processed, you simply call the <a href="../../../../nbbc-1.4.5/doc/src/api_rule.html#ref_parser_AddRule"><tt>AddRule</tt></a>
...
on <a href="../../../../nbbc-1.4.5/doc/src/app_rule.html">BBCode rule parameters</a>.)</p>  The four parameters
given here are:</p>
...
<li><tt>class</tt>:  This assigns this new rule and its contents to be of a certain
	...
	and <tt>image</tt>.  (See the appendix on <a href="../../../../nbbc-1.4.5/doc/src/app_class.html">content
...
<li><tt>allow_in</tt>:  This is a list of which tag classes this new tag may
	...
	to each other, see the appendix on <a href="../../../../nbbc-1.4.5/doc/src/app_class.html">content classes</a>.</li>
</ul>
