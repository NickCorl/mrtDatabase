...
larry@example.com, for all your searching needs!</xmp>
...
<a href="mailto:larry@example.com">larry@example.com</a>, for all your searching needs!</div>
...
turns them into links.  It uses a template system just like <a href="../../../../nbbc-1.4.5/doc/src/usage_enh.html">BBCODE_MODE_ENHANCED</a>
...
<xmp class='code'>$bbcode = new BBCode;
$bbcode->SetDetectURLs(true);
$bbcode->SetURLPattern('<a href="{$url/h}">{$text/h} <img src="../../../../nbbc-1.4.5/doc/src/external.gif"
    width="11" height="11" alt="External Link" /></a>');
$output = $bbcode->Parse($input);</xmp>

<div class='output_header'>Output:</div>
<div class='output'>Go to <a href="http://www.google.com/">www.google.com <img src="../../../../nbbc-1.4.5/doc/src/external.gif" width="11" height="11" alt="External Link" border="0" /></a> for all your searching needs!</div>

<p>For additional documentation on templating, see the <a href="../../../../nbbc-1.4.5/doc/src/api_misc.html#ref_parser_FillTemplate">FillTemplate()</a>
function, which is shared by all of the template code in NBBC and can be used in your own programs as
well; and also see the list of <a href="../../../../nbbc-1.4.5/doc/src/app_enhflags.html">template flags</a>.</p>
