...
[[George H. W. Bush]] and [[Bill Clinton]].</xmp>
...
<a href="http://en.wikipedia.org/wiki/Bill_Clinton">Bill Clinton</a>.</div>
...
with the main URL provided by the <a href="../../../../nbbc-1.4.5/doc/src/api_wiki.html#ref_parser_SetWikiURL"><tt>SetWikiURL()</tt></a>
...
$bbcode->SetWikiURL("http://en.wikipedia.org/wiki/");</xmp>
...
<ol>
<li>The <tt>[[Ronald&nbsp;Reagan]]</tt> wiki-link is converted to a <tt>[wiki="Ronald&nbsp;Reagan"&nbsp;title="Ronald&nbsp;Reagan"]</tt> tag.</li>
<li>The parser looks for a rule for the new <tt>[wiki]</tt> tag.  A rule is provided by the Standard BBCode Library,
	and unless you override it (with <a href="../../../../nbbc-1.4.5/doc/src/api_rule.html#ref_parser_AddRule">AddRule()</a>, as in another example below),
	that rule will process the tag.</li>
<li>The standard wiki-link rule uses the <a href="../../../../nbbc-1.4.5/doc/src/api_wiki.html#ref_parser_Wikify">Wikify()</a> function
...
<div class='code_header'>Code:</div>
<xmp class='code'>$bbcode = new BBCode;
$bbcode->SetWikiURL("http://www.thewotch.com/?epDate=");</xmp>
...
<div class='code_header'>Code:</div>
<xmp class='code'>$bbcode = new BBCode;
$bbcode->SetWikiURL("http://mercurynews.com/ci_");</xmp>
<div class='code_header'>User input:</div>
...
<xmp class='code'>[[20080717:As expected, EU widens antitrust probe of Intel]]</xmp>
<div class='output_header'>Output:</div>
<div class='output'><a href="http://arstechnica.com/news.ars/post/20080717-as-expected-eu-widens-antitrust-probe-of-intel.html">As expected, EU widens antitrust probe of Intel</a></div>
