...
<li><b><tt>'method'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i>  <tt>""</tt>)<br />
	...
	<li><tt>BBCODE_MODE_CALLBACK</tt>:  This may be a string, for calling a function,
		...
		define a callback function.  See the section on <a href="../../../../nbbc-1.4.5/doc/src/usage_call.html">callback tags</a> for more details
	...
	<li><tt>BBCODE_MODE_INTERNAL</tt>:  This is a string, the name of an internal
		method of an instance of class <a href="../../../../nbbc-1.4.5/doc/src/api.html"><tt>BBCode</tt></a>.</li>
...
<li><b><tt>'allow_in'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i>  <tt>array('block')</tt>)</li>
	...
	placed inside.  See the description of <a href="../../../../nbbc-1.4.5/doc/src/app_class.html">content classes</a> below
...
<li><b><tt>'class'</tt></b> &nbsp; &nbsp; &nbsp; &nbsp; (<i>Default value:</i>  <tt>'block'</tt>)</li>
	...
	<a href="../../../../nbbc-1.4.5/doc/src/app_class.html">content classes</a> below to understand how this is used.<br /><br /></li>
