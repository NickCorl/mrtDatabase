...
<div class='output'><img src="http://img.photobucket.com/albums/v63/phantom-inker/other/forum-mod.png" width='91' height='100' alt="forum-mod.png" /></div>
...
$bbcode->SetLocalImgDir("/home/example.com/foo/images/");</xmp>

<p>(Note that the local image directory passed to <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetLocalImgDir"><tt>SetLocalImgDir()</tt></a>
<i>must</i> be the full server path to the local image directory; and the address given to <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetLocalImgURL"><tt>SetLocalImgURL()</tt></a>
