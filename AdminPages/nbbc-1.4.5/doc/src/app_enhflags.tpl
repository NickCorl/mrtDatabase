...
causes this variable to be passed through <a href="../../../../nbbc-1.4.5/doc/src/api_misc.html#ref_parser_HTMLEncode">HTMLEncode()</a>.
...
<li><b><tt>e</tt> - Apply <a href="../../../../nbbc-1.4.5/doc/src/api_misc.html#ref_parser_HTMLEncode"><tt>BBCode::HTMLEncode()</tt></a></b> to the variable.</li>
<li><b><tt>h</tt> - Apply <tt>htmlspecialchars()</tt></b> to the variable.</li>
<li><b><tt>k</tt> - Apply <a href="../../../../nbbc-1.4.5/doc/src/api_wiki.html#ref_parser_Wikify"><tt>BBCode::Wikify()</tt></a></b> to the variable.</li>
