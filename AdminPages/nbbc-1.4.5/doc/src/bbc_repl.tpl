...
<p class='bblib'><b><tt>[img]...[/img]</tt></b><br />
	...
	<a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetLocalImgDir">local image directory</a>, and will (A) determine that the
...
<p class='bblib'><b><tt>[rule]</tt></b><br />
	...
	<a href="../../../../nbbc-1.4.5/doc/src/api_rule.html#ref_parser_SetRuleHTML">SetRuleHTML</a> function.  The <tt>[rule]</tt> tag does not have an end tag.</p>
