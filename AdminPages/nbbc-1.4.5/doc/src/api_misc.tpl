...
<div class='api'>
	...
	<div class='api_descr'>This function is used by the parser in a number of
		...
		associated with <a href="../../../../nbbc-1.4.5/doc/src/usage_enh.html">enhanced tags</a>.  It is exposed
	...
	<div class='api_info'><b>Return Value:</b>  A string with all variable inserts replaced with values,
		possibly formatted with <a href="../../../../nbbc-1.4.5/doc/src/app_enhflags.html">formatting flags</a> if any have been given.</div>
	<div class='api_info_block'><b>Note:</b><br /><br />
		...
		<li><tt>{$param/flags}</tt> - A replaced variable that has <a href="../../../../nbbc-1.4.5/doc/src/app_enhflags.html">formatting flags</a>
