...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current HTML rule output.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetRuleHTML">SetRuleHTML()</a> for more details.</div>
	<div class='api_info'><b>Return values:</b>  Returns a string containing HTML, the
		same HTML most-recently given to <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetRuleHTML">SetRuleHTML()</a>,
		or "<tt>&lt;hr&nbsp;/&gt;</tt>" if SetRuleHTML() has never been called.</div>
</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the default HTML rule output provided by
		the Standard BBCode Library.</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current local image directory.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetLocalImgDir">SetLocalImgDir()</a> for more details.</div>
	<div class='api_info'><b>Return values:</b>  Returns the current local image directory.
		If no local image directory has been set, this returns simply "img".</div>
</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current local image URL.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetLocalImgURL">SetLocalImgURL()</a> for more details.</div>
	<div class='api_info'><b>Return values:</b>  Returns the current local image URL.
		If no local image URL has been set, this returns simply "img".</div>
</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current setting for the URL-targetable security flag.
		See <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetURLTargetable">SetURLTargetable()</a> for more details.</div>
...
<div class='api'>
	...
	<div class='api_descr'>This function returns the current setting for the URL target.  This will either
		...
		See <a href="../../../../nbbc-1.4.5/doc/src/api_repl.html#ref_parser_SetURLTarget">SetURLTarget()</a> for more details.</div>
...
<div class='api'>
	...
	<div class='api_info'><b>Parameters:</b>
		...
		<li><tt><i>setting</i></tt>: If false, the <tt>[url]</tt> tag will either allow
			...
			and any user-supplied target will be ignored.</li>
		</ul>
	</div>
	<div class='api_info_block'>The URL target setting controls whether the <tt>[url]</tt> tag will
		...
		the window of your choice, be it "_blank" or some specific custom window.</div>
</div>
